...
public class Gleed2DMapLoader extends
    ...
    private void loadItems(Element objects, MapLayer layer) {
        for (Element xml_Item : objects.getChildrenByName("Item")) {
            ...
            } /* Parse a Path Item */ else if (type.equals("PathItem")) {
            ...
            } /* Parse a Rectangle Item */ else if (type.equals("RectangleItem")) {
                // TODO: FillColor parsen
                float width = Float
            ...
            } /* Parse a Texture Item */ else if (type.equals("TextureItem")) {
