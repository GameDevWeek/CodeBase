...
public class PhysixUtil {
    ...
    public static void createHollowCircle(PhysixBodyComponent component, PhysixSystem system, float x, float y, float radius, int sides, float sideStrength) {
        ...
        component.init(bodyDef, system, null);
    ...
    public static void createCapsuleBody(PhysixBodyComponent component, PhysixFixtureDef fixtureDef, float length, float radius) {
        ...
        component.createFixture(fixtureDef.shapeCircle(radius, pos));
        pos.y += length;
        component.createFixture(fixtureDef.shapeCircle(radius, pos));
    }
}
