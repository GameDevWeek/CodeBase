...
public class EntityFactory {
    ...
    public static void constructCat(Vector2 pos, float maxVelocity,
        ...
        MovementComponent catMove = new MovementComponent(maxVelocity,
                middleVelocity, minVelocity, acceleration, new Vector2(1, 1));
    ...
    public static void constructDog(Vector2 pos, float maxVelocity,
        ...
        PositionComponent dogPosition = new PositionComponent(new Vector2(
                (int) pos.x, (int) pos.y));
    ...
    public static void constructHole(Vector2 pos) {
        ...
        PositionComponent holePosition = new PositionComponent(new Vector2(
                (int) pos.x, (int) pos.y));
