 ...
 */
public class FontXLoader extends AsynchronousAssetLoader<FontX, FontXLoader.FontXParameter> {
	public FontXLoader (FileHandleResolver resolver) {
		super(resolver);
	}

	@Override
	public Array<AssetDescriptor> getDependencies (String fileName, FileHandle fileHandle, FontXParameter parameter) {
	...
	@Override
	public void loadAsync (AssetManager manager, String fileName, FileHandle fileHandle, FontXParameter parameter) {
	}

	@Override
	public FontX loadSync (AssetManager manager, String fileName, FileHandle fileHandle, FontXParameter parameter) {
