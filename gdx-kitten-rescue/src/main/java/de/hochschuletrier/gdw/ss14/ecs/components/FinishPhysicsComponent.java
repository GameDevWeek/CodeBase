 ...
 */
public class FinishPhysicsComponent extends PhysicsComponent
{
    ...
    public FinishPhysicsComponent(Vector2 position, float width, float height, float rotation)
    {
    ...
    public void initPhysics(PhysixManager manager) {
        ...
        physicsBody.createFixture(fixturedef.shapeBox(width, height)).setUserData("Finish");
