...
public class SoundManager {
	...
	private static int katzeTodesschreiNurEinmal = 0;
			...
			case GAMEPLAY:
				switch (actionString) {
					...
					case "JUMPING_IN_BOX": 
						...
						break;
					case "KILLING": 
						if(katzeTodesschreiNurEinmal == 0) {
							tmp = random(0,2);
							switch (tmp) {
							...
							katzeTodesschreiNurEinmal++;
						}
						else if(katzeTodesschreiNurEinmal > 120){
							katzeTodesschreiNurEinmal = 0;
						}
						else {
							katzeTodesschreiNurEinmal++;
						}
