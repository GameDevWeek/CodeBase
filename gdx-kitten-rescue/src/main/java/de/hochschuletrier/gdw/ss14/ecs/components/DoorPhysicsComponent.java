 ...
 */
public class DoorPhysicsComponent extends PhysicsComponent
{
    ...
    public DoorPhysicsComponent(Vector2 position, float width, float height, float rotation, short mask, short category, short group)
    {
    ...
    public void initPhysics(PhysixManager manager) {
        ...
        physicsBody.createFixture(fixturedef.shapeBox(width, height)).setUserData("Door");
